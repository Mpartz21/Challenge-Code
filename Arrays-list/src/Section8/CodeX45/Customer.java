...
3.Customer
 ...
 A constructor that takes aString (name of customer) and a double (initial transaction). It initialises name and instantiates transactions.
...
Be extremely careful with the spelling of the names of the fields, constructors and metods.
