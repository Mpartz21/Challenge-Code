...
public class Point {
    ...
    public double distance(Point thisPoint){
        double distance = Math.sqrt((this.x - thisPoint.getX()) * ( this.x - thisPoint.getX()) +
                ( this.y - thisPoint.getY() ) * (this.y - thisPoint.getY()));
        return distance;
    }

    public static void main(String[] args) {
//        Point test = new Point(5,5);
//        Point otherTest = new Point(10,10);
//        System.out.println(test.distance());
//        System.out.println(test.distance(otherTest));
        Point first = new Point(6, 5);
        Point second = new Point(3, 1);
        System.out.println("distance(0,0)= " + first.distance());
        System.out.println("distance(second)= " + first.distance(second));
