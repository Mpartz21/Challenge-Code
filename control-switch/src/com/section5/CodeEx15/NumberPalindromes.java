...
Tip: Logic to check a palindrome numb
...
public class NumberPalindromes {
    ...
    public static boolean isPalindrome(int number){
        boolean numberIsPalindrome;
        int numberCopy = number;
        int reverseNumber=0;

        for(;numberCopy != 0;numberCopy /= 10){
            int extractedDigit = numberCopy % 10;
            reverseNumber = (reverseNumber * 10) + extractedDigit ;
        }
    ...
    public static void main(String[] args) {
        ...
        boolean isItpalindrome = isPalindrome(-1221);
