...
NOTE: Do not add a 0main method to the solution code.
 */
public class NumberToWorlds {
    public static void numberToWords(int number){
        ...
        int differenceOfDigits = getDigitCount(number) - getDigitCount(reversedNumber);

        for(;reversedNumber != 0;reversedNumber /= 10){
            int extractedDigit = reversedNumber % 10;
            switch (extractedDigit){
                case 0:
                    System.out.println("Zero");
                    break;
                case 1:
    ...
    public static void main(String[] args) {
        int testReverse = reverse(100);
        System.out.println(testReverse);

        int testDigitCount = getDigitCount(78984);
        System.out.println(testDigitCount);
        numberToWords(11);
    }
}
