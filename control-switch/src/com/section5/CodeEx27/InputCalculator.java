...
public class InputCalculator {
    public static void inputThenPrintSumAndAverage () {
        ...
        Double doubleSum = new Double(intSum);
        Double doubleCount = new Double(intCount);
        System.out.println("SUM = " + intSum + " AVG = " + Math.round(doubleSum / doubleCount));
    }
